...
extern "C" {
    ...
    PHPCPP_EXPORT void *get_module() 
    {
        ...
        pdfDocument.property("IMAGE_JPEG", 1, Php::Const|Php::Public);
        pdfDocument.property("IMAGE_PNG", 2, Php::Const|Php::Public);
        pdfDocument.property("IMAGE_TIFF", 3, Php::Const|Php::Public);
