...
COMPILER_FLAGS		=	-Wall -g -c -O2 -std=c++11 -fpic `pkg-config poppler-cpp fontconfig openssl --cflags`
LINKER_FLAGS		=	-shared
LINKER_DEPENDENCIES	=	-lphpcpp -lPDFWriter `pkg-config poppler-cpp fontconfig openssl --libs`
